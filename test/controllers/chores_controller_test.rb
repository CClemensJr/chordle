...
class ChoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post chores_url, params: { chore: { completed_at: @chore.completed_at, details: @chore.details, priority: @chore.priority, time_to_complere: @chore.time_to_complere, title: @chore.title } }
    end
  ...
  test "should update chore" do
    patch chore_url(@chore), params: { chore: { completed_at: @chore.completed_at, details: @chore.details, priority: @chore.priority, time_to_complere: @chore.time_to_complere, title: @chore.title } }
